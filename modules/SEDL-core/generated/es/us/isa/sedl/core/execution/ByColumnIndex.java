...
/**
 * <p>Clase Java para ByColumnIndex complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ByColumnIndex"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://isa.us.es/sedl/core/execution}ColumnBasedDataMapping"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="columnIndexToVariable" type="{http://isa.us.es/sedl/core/execution}ColumnIndexMapper" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ByColumnIndex", propOrder = {
    "columnIndexToVariable"
})
public abstract class ByColumnIndex
    extends ColumnBasedDataMapping
    implements Cloneable, CopyTo, Equals, HashCode
{

    @XmlElement(required = true)
    protected List<ColumnIndexMapper> columnIndexToVariable;
     ...
     * {@link ColumnIndexMapper }
     * 
     * 
     */
    public List<ColumnIndexMapper> getColumnIndexToVariable() {
        if (columnIndexToVariable == null) {
            columnIndexToVariable = new ArrayList<ColumnIndexMapper>();
        }
        return this.columnIndexToVariable;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ByColumnIndex)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ByColumnIndex that = ((ByColumnIndex) object);
        {
            List<ColumnIndexMapper> lhsColumnIndexToVariable;
            ...
            List<ColumnIndexMapper> rhsColumnIndexToVariable;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ColumnIndexMapper> theColumnIndexToVariable;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (target instanceof ByColumnIndex) {
            final ByColumnIndex copy = ((ByColumnIndex) target);
            if ((this.columnIndexToVariable!= null)&&(!this.columnIndexToVariable.isEmpty())) {
                List<ColumnIndexMapper> sourceColumnIndexToVariable;
                ...
                List<ColumnIndexMapper> copyColumnIndexToVariable = ((List<ColumnIndexMapper> ) strategy.copy(LocatorUtils.property(locator, "columnIndexToVariable", sourceColumnIndexToVariable), sourceColumnIndexToVariable));
                copy.columnIndexToVariable = null;
                if (copyColumnIndexToVariable!= null) {
                    List<ColumnIndexMapper> uniqueColumnIndexToVariablel = copy.getColumnIndexToVariable();
